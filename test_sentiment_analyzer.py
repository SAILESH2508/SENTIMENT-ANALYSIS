...
class TestSentimentAnalyzer:
    ...
    def analyzer_with_mock_pipeline(self, mock_pipeline):
        ...
        with patch('enhanced_inference_service.joblib.load', return_value=mock_pipeline):
            with patch('enhanced_inference_service.ensure_model_exists', return_value=True):
...
class TestPerformanceMonitor:
    ...
    def test_parse_prediction_logs(self, temp_log_file):
        ...
        df = monitor.parse_prediction_logs(days_back=30)  # Large window to catch test data
